...
namespace Repo
{
    public class Car : IVehicle
    {
        ...
        public string Fuel { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        public string Gear { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        public int KM { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        public int Door { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    }
